...
<body class="text-slate-700 pb-[100px] md:pb-0 pt-20">
    ...
    <header class="fixed top-3 left-1/2 -translate-x-1/2 w-[calc(100%-1rem)] md:w-max max-w-6xl z-50 glass-panel shadow-md rounded-full transition-all border border-slate-200">
        <div class="px-4 md:px-5 py-2 flex items-center justify-between md:justify-center md:gap-10 relative">
        ...
        <div class="bg-brand-500 text-white p-2 rounded-full shadow-md">
                ...
                <div class="flex flex-col pr-1">
                    ...
                    <span class="text-[10px] font-bold text-brand-400 mt-1">خدمات حرفه‌ای ساختمان</span></div>
    </a>
            ...
            <div class="container mx-auto px-4 text-center z-10 relative">
                ...
                <div class="mt-8 border-t border-slate-200/50 pt-8 pb-4" id="services">
                    <div class="flex items-center justify-center gap-4 mb-8">
                        ...
                        <h2 class="text-xl md:text-2xl font-black text-slate-800">خدمات بهدون</h2>
