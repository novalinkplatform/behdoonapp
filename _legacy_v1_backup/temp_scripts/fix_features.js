...
const sIdx = content.indexOf('<section class="py-16 md:py-24 bg-white relative overflow-hidden" id="features">');
if (sIdx !== -1) {
    ...
    <section class="py-16 md:py-24 bg-white relative overflow-hidden" id="features">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex items-center justify-center gap-4 mb-10">
                ...
                <h2 class="text-xl md:text-3xl font-black text-slate-800">چرا بهدون رو انتخاب کنیم؟</h2>
