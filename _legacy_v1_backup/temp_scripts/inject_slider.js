...
const reviews = [
    { name: "علی م.", svc: "تعمیرات لوله کشی", text: "کارشون بسیار دقیق و تمیز بود. نشتی لوله رو با دستگاه تشخیص دادن و بدون خرابی زیاد درستش کردن." },
    { name: "مریم ر.", svc: "سرمایش و گرمایش", text: "تیم بهدون خیلی سریع برای تعمیر پکیج ما آمدند. برخوردشان عالی بود و مشکل کاملاً برطرف شد." },
    { name: "سعید ک.", svc: "برقکاری ساختمان", text: "برای اتصالی برق تماس گرفتم، در کمتر از یک ساعت رسیدن و مشکل رو با هزینه منصفانه حل کردن." },
    { name: "فاطمه س.", svc: "بازسازی خانه", text: "بازسازی سرویس بهداشتی رو بهشون سپردیم. هم مصالح خوبی استفاده کردن و هم سر وقت تحویل دادن." },
    { name: "رضا ن.", svc: "نصب و تعمیر کولر", text: "کولر گازی ما مشکل خنک کنندگی داشت، سرویس کارشون با حوصله گاز کولر رو شارژ کرد و الان عالیه." },
    { name: "زهرا ت.", svc: "تعمیرات تاسیسات", text: "پشتیبانی عالی داشتن و بعد از کار هم پیگیر بودن که مشکلی نداشته باشیم. واقعا راضیم." },
    { name: "محمد ح.", svc: "لوله بازکنی", text: "نصف شب لوله آشپزخونه گرفته بود، تماس گرفتیم و فوراً یک متخصص فرستادن. دستشون درد نکنه." },
    { name: "امیر ج.", svc: "سیم کشی و برق", text: "کل سیم کشی واحد ما رو تعویض کردن. کارشون حرفه ای بود و قیمت هاشون هم نسبت به بقیه منصفانه بود." }
];
            ...
            <div class="flex overflow-x-auto snap-x snap-mandatory hide-scrollbar gap-4 md:gap-6 pb-6 px-4 md:px-8 -mx-4 md:-mx-8 scroll-pl-4 md:scroll-pl-8">
                ...
                <div class="snap-center shrink-0 w-[280px] md:w-[320px] bg-white border border-slate-200 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow relative flex flex-col">
                    ...
                    <div class="flex items-center gap-3 mt-auto relative z-10 border-t border-slate-100 pt-4">
                        <div class="w-10 h-10 rounded-full bg-brand-50 text-brand-600 flex items-center justify-center font-bold text-lg border border-brand-100">${r.name.charAt(0)}</div>
                        <div>
...
// Inject before <!-- ================= UNIFIED ISLAND FOOTER ================= -->
// Since there might be two occurrences (one in `html` and one in `footerHTML`), we use replaceAll.
const target = '<!-- ================= UNIFIED ISLAND FOOTER ================= -->';
if (content.includes(target)) {
    content = content.split(target).join(sliderHtml + '\n    ' + target);
