...
const servicesData = {
  "hvac": {
    ...
    "subServices": [
      { "name": "نصب و سرویس کولر آبی", "icon": "M12 3v18m-4-14h8m-8 10h8M6 8a6 6 0 1112 0 6 6 0 01-12 0z" },
      { "name": "نصب و سرویس پکیج", "icon": "M12 3v18m-4-14h8m-8 10h8M6 8a6 6 0 1112 0 6 6 0 01-12 0z" },
      { "name": "نصب و سرویس رادیاتور شوفاژ", "icon": "M12 3v18m-4-14h8m-8 10h8M6 8a6 6 0 1112 0 6 6 0 01-12 0z" },
      { "name": "تعمیر و سرویس آبگرمکن", "icon": "M12 3v18m-4-14h8m-8 10h8M6 8a6 6 0 1112 0 6 6 0 01-12 0z" }
    ],
    "content": `
  ...
  "plumbing": {
    ...
    "subServices": [
      { "name": "نصب و تعمیر شیرآلات", "icon": "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
      { "name": "نصب سینک ظرفشویی", "icon": "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
      { "name": "تشخیص و ترمیم ترکیدگی لوله", "icon": "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
      { "name": "رفع نم و نشتی و رطوبت", "icon": "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
      { "name": "نصب و سرویس منبع آب", "icon": "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
      { "name": "نصب و تعمیر دستگاه تصفیه آب", "icon": "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
      { "name": "نصب و سرویس توالت فرنگی و ایرانی", "icon": "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
      { "name": "نصب و تعمیر فلاش تانک و سیفون", "icon": "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
      { "name": "نصب روشویی", "icon": "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
      { "name": "نصب و تعمیر وال هنگ", "icon": "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
      { "name": "لوله کشی آب و فاضلاب", "icon": "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
      { "name": "اتصال به شبکه فاضلاب شهری", "icon": "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" }
    ],
    "content": `
        <p class="mb-4">محتوای این بخش در حال آماده‌سازی است.</p>
    `
  ...
  "electrical": {
    ...
    "subServices": [
      { "name": "نصب و تعمیر آیفون صوتی و تصویری", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "سیم کشی و کابل کشی", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب لوستر و چراغ", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "رفع اتصالی", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "رفع خرابی و سیم کشی تلفن", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب و تعمیر دوربین مداربسته", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب و تعمیر آنتن تلویزیون", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "کلید و پریز", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب و تعمیر ژنراتور و یو پی اس", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب پنل خورشیدی", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب و تعمیر جک پارکینگ و آرام بند", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "تعمیر و سرویس آسانسور", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب و تعمیر کرکره برقی", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب و تعویض فیوز", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "هواکش و تهویه مطبوع", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب و تعمیر بالابر", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب و تعمیر دزدگیر اماکن", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب محافظ برق و استابلایزر", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "ساخت و تعمیر تابلو تبلیغاتی", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "خدمات برق صنعتی و سه فاز", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "رفع خرابی و نصب سانترال", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "طراحی و اجرای نور مخفی", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب سنسور و تایمر", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "سیم پیچی", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "نصب داکت و ترانکینگ", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "ساخت و تعمیر تابلو برق", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "سیستم اعلام و اطفاء حریق", "icon": "M13 10V3L4 14h7v7l9-11h-7z" },
      { "name": "سیم کشی ارت", "icon": "M13 10V3L4 14h7v7l9-11h-7z" }
    ],
    "content": `
        <p class="mb-4">محتوای این بخش در حال آماده‌سازی است.</p>
    `
  ...
  "renovation": {
    ...
    "subServices": [
      { "name": "نقاشی و رنگ کاری ساختمان", "icon": "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
      { "name": "کاشی کاری و سرامیک", "icon": "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
      { "name": "بنایی و تخریب", "icon": "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
      { "name": "گچ کاری و لکه گیری", "icon": "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
      { "name": "عایق کاری پشت بام (ایزوگام و قیرگونی و...)", "icon": "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
      { "name": "کنافکاری", "icon": "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
      { "name": "نصب کاغذ دیواری", "icon": "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
      { "name": "پارکت و لمینت", "icon": "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
      { "name": "سنگ کاری", "icon": "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
      { "name": "تعمیرات نما", "icon": "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" }
    ],
    "content": `
        <p class="mb-4">محتوای این بخش در حال آماده‌سازی است.</p>
    `
    ...
    <main class="min-h-screen bg-slate-50 flex flex-col" dir="rtl">
        ...
        <header class="sticky top-4 z-50 mx-4 md:mx-8 bg-white/60 backdrop-blur-xl border border-white/70 rounded-2xl shadow-[0_10px_30px_rgba(23,22,20,0.12),inset_0_1px_0_rgba(255,255,255,0.9)] p-3 md:px-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-4">
                <a href="/admin" class="flex items-center gap-2 bg-white/80 p-2 px-3 rounded-xl shadow-sm hover:bg-slate-50 transition-colors" title="رفرش و بازگشت به داشبورد">
