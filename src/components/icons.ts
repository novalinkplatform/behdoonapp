...
export const icons = {
  ...
  baleFilled: `<svg ${FILLED_ICON_ATTRS}><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2Zm-1.8 14.5-3.7-3.7 1.4-1.4 2.3 2.3 5.3-5.3 1.4 1.4-6.7 6.7Z"/></svg>`,

  eitaaFilled: `<svg ${FILLED_ICON_ATTRS}><path d="M12 2.2C6.6 2.2 2.2 6.6 2.2 12c0 2.2.7 4.2 2 5.9L3 21.8l4.1-1.1c1.5.9 3.2 1.5 4.9 1.5 5.4 0 9.8-4.4 9.8-9.8S17.4 2.2 12 2.2Zm4.2 13.6c-1.3 1-3.2 1.2-4.7.5-1.5-.7-2.6-2.1-3-3.7-.4-1.6 0-3.3 1.1-4.5 1-.9 2.5-1.3 3.8-.9.6.2 1 .7 1.1 1.3.1.6-.2 1.2-.7 1.5-.5.3-1.1.2-1.6 0-.6-.2-1.3 0-1.7.5-.4.5-.5 1.2-.2 1.8.3.6.9 1 1.6 1.1.7.1 1.4-.2 1.9-.7.5-.5 1.3-.6 1.9-.2.6.4.8 1.1.5 1.8-.3.7-1 1.2-1.7 1.5Z"/></svg>`,

  rubikaFilled: `<svg ${FILLED_ICON_ATTRS}><path d="M12 2.5c-5.2 0-9.5 4.3-9.5 9.5s4.3 9.5 9.5 9.5 9.5-4.3 9.5-9.5-4.3-9.5-9.5-9.5Zm0 3.2 4.5 3.3v5.5L12 17.8l-4.5-3.3V9l4.5-3.3Z"/></svg>`,

  aparatFilled: `<svg ${FILLED_ICON_ATTRS}><path d="M12 2.5C6.75 2.5 2.5 6.75 2.5 12s4.25 9.5 9.5 9.5 9.5-4.25 9.5-9.5S17.25 2.5 12 2.5Zm-2 5.2a1.8 1.8 0 1 1 0 3.6 1.8 1.8 0 0 1 0-3.6Zm4 0a1.8 1.8 0 1 1 0 3.6 1.8 1.8 0 0 1 0-3.6Zm0 7.6a1.8 1.8 0 1 1 0 3.6 1.8 1.8 0 0 1 0-3.6Zm-4 0a1.8 1.8 0 1 1 0 3.6 1.8 1.8 0 0 1 0-3.6Z"/></svg>`,
