...
export function renderCostChart(estimate: CostEstimate, invoice?: DetailedInvoice): string {
  ...
  return `
    <div class="cost-chart">
      <div class="cost-chart-svg-wrap">
        <svg viewBox="0 0 400 150" role="img" aria-label="${pick('نمودار برآورد هزینه خدمات تخصصی بهدون', 'Behdoon service cost estimate chart')}">
      ...
      <div class="cost-chart-avg-value">
        <span class="cost-chart-avg-caption">${pick('میانگین برآورد هزینه خدمات', 'Average estimated cost')}</span>
